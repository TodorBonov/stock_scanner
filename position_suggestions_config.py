...
Dedicated config for 05_position_suggestions.py – rules for suggesting actions on open positions.
...
# 5. Grade strong + below target 1 -> HOLD or ADD (if ALLOW_ADD_ON_STRONG_GRADE)
# 6. Else -> HOLD
